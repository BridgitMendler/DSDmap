  ...
  const onUsernameSubmitted = (username) => {
    fetch('http://dsdmap.media.mit.edu:3001/users', {
      ...
      .then(response => { 
        ...
        if (usernameTwo['password'] === 'session253pm' && usernameTwo['consent'] === 'I consent' && usernameTwo['username'] !== ''||usernameTwo['password'] === 'session253pm' && usernameTwo['consent'] === '' && usernameTwo['username'] !== ''){
